...
const debug = require('debug')('dply:node-zookeeper-client:Exception')

const { invert, forEach } = require('lodash')
...
const MESSAGES = {
  ...
  '-5': 'The server had an error marshalling and unmarshalling data'
}
...
class Exception extends Error {
  ...
  static init(){
    ...
    debug('this.DATA_INCONSISTENCY',this.DATA_INCONSISTENCY)
    this.CODES = CODES
    debug('this.DATA_INCONSISTENCY',this.CODES.DATA_INCONSISTENCY)
