...
class State {
  ...
  static init(){
    this.DISCONNECTED         = new State('DISCONNECTED', 0)
    this.CONNECTING           = new State('CONNECTING', 2)
    this.CONNECTED            = new State('CONNECTED', 3)
    this.AUTH_FAILED          = new State('AUTH_FAILED', 4)
    this.CONNECTED_READ_ONLY  = new State('CONNECTED_READ_ONLY', 5)
    this.SASL_AUTHENTICATED   = new State('SASL_AUTHENTICATED', 6)
    this.EXPIRED              = new State('EXPIRED', -122)
