...
const {defaults, clone} = require('lodash')
...
const { attempt }       = require('./functions')
...
module.exports = class Client extends events.EventEmitter {
  ...
  constructor( connectionString, options = {} ) {
    ...
    this.state = this.connectionManager.state
   ...
   */
  close (cb) {
    return this.connectionManager.close(cb)
  }
   ...
   */
  getState () {
    let state = this.connectionManager.state
