...
class JuteDataZkId extends Record {
  ...
  set scheme(val){ this._scheme = JuteTypeString.create(val) }

  get id (){ return this._id }
  set id(val){ this._id = JuteTypeString.create(val) }
}
JuteDataZkId.spec = {
  order: ['scheme', 'id'],
  attributes: {
...
class JuteDataZkACL extends Record {
  ...
  set perms(val){ this._perms = JuteTypeInt.create(val) }
  get id (){ return this._id }
  set id(val){ this._id = JuteDataZkId.create(val) }
}
JuteDataZkACL.spec = {
  order: [ 'perms', 'id' ],
  attributes: {
...
class JuteDataZkStat extends Record {
  ...
  set czxid(val)  { this._czxid = JuteTypeLong.create(val) }
  
  get mzxid()     { return this._mzxid }
  set mzxid(val)  { this._mxzid = JuteTypeLong.create(val) }
  
  get ctime()     { return this._ctime }
  set ctime(val)  { this._ctime = JuteTypeLong.create(val) }
  
  get mtime()     { return this._mtime }
  set mtime(val)  { this._mtime = JuteTypeLong.create(val) }
  
  get cversion()  { return this._cversion }
  set cversion(val){ this._cversion = JuteTypeInt.create(val) }
  
  get aversion()  { return this._aversion}
  set aversion(val){ this._aversion = JuteTypeInt.create(val) }

  get ephemeralOwner(){return this._ephemeralOwner }
  set ephemeralOwner(val){ this._ephemeralOwner = JuteTypeLong.create(val) }

  get dataLength(){ return this._dataLength }
  set dataLength(val){ this._dataLength = JuteTypeInt.create(val)}

  get numChildren(){ return this._numChildren }
  set numChildren(val){ this._numChildren = JuteTypeInt.create(val) }

  get pzxid(){ return this._pzxid }
  set pzxid(val){ this._pzxid = JuteTypeLong.create(val) }
...
// We get a packet in response to close with 
// just the current xid
class CloseResponse extends Record {
  constructor(nil1, xid, nil2){
    super(arguments)
    this.nil1 = nil1
    this.xid = xid
    this.nil2 = nil2
  }
  get nil1(){ return this._nil1}
  set nil1(val){ this._nil1 = JuteTypeInt.create(val)}

  get xid(){ return this._xid}
  set xid(val){ this._xid = JuteTypeLong.create(val)}

  get nil2(){ return this._nil2}
  set nil2(val){ this._nil2 = JuteTypeInt.create(val)}
}
CloseResponse.spec = {
  order: ['nil1','xid','nil2'],
  attributes: {
...
class GetDataResponse extends Record {
  ...
  set stat(val){ this._stat = JuteDataZkStat.create(val) }
}
