const debug = require('debug')('dply:node-zookeeper-client:jute:Serialize')
...
class Serialize {
  ...
  static vector( value, buffer, offset, type ){
  ...
  static byType ( type, value, buffer, offset ){
    ...
    if ( this[type] ) return this[type]( value, buffer, offset, type )
