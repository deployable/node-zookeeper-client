...
class Record {
  ...
  constructor(...args) {
    ...
    debug('created Record %s with', this._uid, ...args)
    this.debug = require('debug')(`dply:node-zookeer-client:jute:Record[${this._uid}]`)
  ...
  deserialize(buffer, offset) {
    ...
    this.debug('%s deserialize %s', this.constructor.name, this._spec.order, my_types)
    forEach(this._order, attribute => {
