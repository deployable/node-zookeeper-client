...
class JuteTypeInt {
  static create(value){
    if (value instanceof JuteTypeInt) return value
...
class JuteTypeLong {
  ...
  static create(value){
    if (value instanceof JuteTypeLong) return value
...
class JuteTypeBoolean {
  ...
  static create(value){
    if (value instanceof JuteTypeBoolean) return value
...
class JuteTypeBuffer {
  ...
  static create(value){
    if (value instanceof JuteTypeBuffer) return value
...
class JuteTypeString {
  ...
  static create(value){
    if (value instanceof JuteTypeString) return value
